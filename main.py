...
class main:
    def __init__(self,root):
        ...
        # frame1 = Frame(self.root).place(x=400, y=100, width=60, height=60)
        #
        # im = Image.open(r"info_icon.png")
        #
        # clearbtn_img = ImageTk.PhotoImage(im)
        # clear_btn1 = Button(frame1, image=clearbtn_img, borderwidth=1)
        # clear_btn1.grid(row=0,column=0)
